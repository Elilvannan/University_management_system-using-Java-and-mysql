            ...
            switch (post) {
                case "STUDENT":
                    ...
                    try {
                        ...
                        while(rs.next()){
                            String user_id = rs.getString("st_id");
                        ...
                        JOptionPane.showMessageDialog(this,"Enter corret user id or password");
                ...
                case "ADMIN":
                    ...
                    try {
                        ...
                        String myStatement = "select * from admin";
                        
                        ResultSet rs = smt.executeQuery(myStatement);
                        
                       while(rs.next()){
                            String user_id = rs.getString("ad_id");
                ...
                case "TECHNICAL":
                    try {
                        ...
                        String myStatement = "select * from technical_officer";
                        
                        ResultSet rs = smt.executeQuery(myStatement);
                        
                        while(rs.next()){
                            String user_id = rs.getString("tec_id");
                ...
                case "LECTURER":
                    try {
                        ...
                        String myStatement = "select * from lecturer";
                        
                        ResultSet rs = smt.executeQuery(myStatement);
                        
                       while(rs.next()){
                            String user_id = rs.getString("lec_id");
